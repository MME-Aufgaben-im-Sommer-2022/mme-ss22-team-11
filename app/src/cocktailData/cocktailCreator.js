...
class CocktailCreator extends Observable {
  ...
  validateFileType (event) {
    const fileName = this.IMAGE_INPUT.value
  ...
  initializeTagInputContainer () {
    const tags = this.CREATOR_TAG_INPUT_CONTAINER.querySelectorAll('.creator-tag')
  ...
  fillIngredientList (container, input) {
    ...
    const ingredientListView = new CreatorIngredientListView(container, input)
    let timeout = null
  ...
  initializeIngredientInputContainer () {
    ...
    this.CREATOR_ING_ADD.addEventListener('click', () => {
      const newCreatorIngInputContainer = this.createIngredientInputContainer()
  ...
  initializeInstructionInputContainer () {
    ...
    this.CREATOR_INS_ADD.addEventListener('click', () => {
      const newCreatorInsInputContainer = this.createInstructionsInputContainer()
  ...
  collectInput () {
    ...
    let image = 'NO_IMAGE'
    const tagList = []
    const tags = document.getElementsByClassName('creator-tag selected')
    const ingredientList = []
    const ingredients = document.getElementsByClassName('creator-ingredient-input')
    const ingredientsQuantity = document.getElementsByClassName('creator-ingredient-quantity-input')
    const ingredientsUnit = document.getElementsByClassName('creator-ingredient-unit-input')
    const stepList = []
    const steps = document.getElementsByClassName('creator-instructions-input')
    ...
    const data = { name, image, stepList, ingredientList }
    data.tags = tagList
    return data
  }
