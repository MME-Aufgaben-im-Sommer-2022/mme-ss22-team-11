...
function validateFileType (event) {
  const fileName = IMAGE_INPUT.value
...
CREATOR_ING_ADD.addEventListener('click', () => {
  const newCreatorIngInputContainer = createIngredientInputContainer()
...
CREATOR_INS_ADD.addEventListener('click', () => {
  const newCreatorInsInputContainer = createInstructionsInputContainer()
